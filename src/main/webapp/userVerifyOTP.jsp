...
<body>
<%
Integer otp = (Integer) session.getAttribute("otpforVerification");
...
try {
    ...
    if (otp != null && otp.equals(votp)) {
        ...
        response.sendRedirect("UserEmailValidation.jsp?message=notvalidotp");
    }
} catch (NumberFormatException e) {
    // Handle the case where the parameter is not a valid integer
    response.sendRedirect("UserEmailValidation.jsp?message=invalidInput");
}
