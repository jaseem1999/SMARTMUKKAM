    ...
    <div class="container">
        ...
        <div class="col">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="shop" name="shop">
                   	 ...
                   	 <option value="retail" selected>Retail shop</option>
					    <option value="wholesale">Wholesale Shop</option>
					    
                </select>
                <span class="error" id="shopError"></span>
            </div>
            <div class="mb-3">
        ...
        <div class="col">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="shopname" name="shopname" placeholder="Enter shop name" required="required">
