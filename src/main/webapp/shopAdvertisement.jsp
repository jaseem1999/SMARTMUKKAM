...
<div class="container-fluid" style="margin-top: 50px;" >
    ...
    <div class="col-sm-10" >
    	<div class="homeFull" style="margin: 50px; height: auto;"  >
    		<div class="home">
    			<span style="color: white;">Add Ads</span>
    		</div>
    		<% 
                        if(alert != null && alert.equals("AdsAddedSuccess")){
                        	out.print("<div id='alert' class='alert alert-success' style='' role='alert'>Product added success</div>");
                        }
    					if(alert != null && alert.equals("AdsAddedFailed")){
				...
				<div class="home">
    				<span style="color: white;">View ads</span>
    			</div>
    			<div style="overflow: auto; height: 300px;" id="contentToRefresh">
	    			<table class="table">
					  ...
					  <tbody>
					  <%
					  List<AdvertisementDTO> products = ShopDAO.getAllAds(sid);
					  for(AdvertisementDTO product : products){
					 %>
					 <tr>
					      ...
					      <td><a href="<%=product.getLink()%>">view</a></td>
					      <td><%
					      ...
					      <td>
							<div class="dropdown">
				                ...
				                <ul class="dropdown-menu">
				                    <li><a href="#" class="dropdown-item acceptLink" data-tid="<%=product.getTid()%>" type="button">Active</a></li>
				                    <li><a href="#" class="dropdown-item rejectLink" data-tid="<%=product.getTid() %>" type="button">Delete</a></li>
				                </ul>
           					 </div>
					      </td>
					    </tr>
