...
<div class="row">
    ...
    <div class="col-sm-9">
    	<div class="homeFull" style="margin: 10px; overflow: auto;">
    		<div class="home">
    			<span>Municipality profile</span>
    		</div>
    		<img alt="" src="images/mukkam-municipality.jpg" width="100%" height="300px;">
    		
    		<div style="width: 100%; height: 30px; background: #819d675c;">
	   			   <span style="margin-left: 20px; font-weight: 600;">Mukkam municipality</span>
	    		</div>
