...
<title>shop forgetten password</title>
</head>
<body>
<div class="container">
	<div class="card" style="margin-top: 200px; position: relative; left: 25%; width: 600px;">
		<form action="shopForgetPasswardServlet.jsp" method="post" style="margin: 20px;">
		...
		<div id="emailHelp" class="form-text" style="color: white;">We'll never share your email with anyone else.</div>
		  ...
		  <button type="submit" class="btn btn-outline-success">Request to get password <i class="fa-solid fa-key"></i></button>
