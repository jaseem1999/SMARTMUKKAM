...
<%@page import="smartMukkam.com.admin.HotelFeedbackDTO"%>
	   	...
	   	<ul class="list-group list-group-flush">
		    ...
		    <li class="list-group-item" style="color: #b66dff; background: #140f0f17;">
		        <a class="nav-link d-flex justify-content-between align-items-center" href="adminHotelReview.jsp">
		            View Feedback Hotel
		            <span><i class="fa-solid fa-hotel" style="color: #b66dff;"></i> <i class="fa-solid fa-comments" style="color: #b66dff;"></i></span>
		        </a>
		    </li>
		    <li class="list-group-item">
  ...
  <ul class="nav justify-content-end">
		  ...
		  <li class="nav-item">
			...
			<div style="height: 370px; width: auto; overflow: auto;">
			    ...
			    <tbody>
			      <%
				 	List<HotelFeedbackDTO> hotel = ServicesDAO.getAllHotelFeedback();
			      for(HotelFeedbackDTO h : hotel){
				  %>
				    <tr>
				    	<td><img src="himg?id=<%=h.getHoid()%>" style="width: 40px; border: 1px solid; border-radius: 5px;" alt="" ></td>
				    	<td><%=h.getFeedback() %></td>
				    </tr>
