...
<div class="container">
	<div class="card" style="margin-top: 200px; position: relative; left: 25%; width: 600px;">
		...
		if(alert != null && alert.equals("failed")){
			out.print("<div id='alert' class='alert alert-danger' style='' role='alert'>Email not registered</div>");
		}

		%>
		<form action="userGetOTPEmailValidation.jsp" method="post" style="margin: 20px;">
