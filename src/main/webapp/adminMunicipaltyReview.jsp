...
<%@page import="smartMukkam.com.admin.MunicipalityFeedbackDTO"%>
	   	...
	   	<ul class="list-group list-group-flush">
		    ...
		    <li class="list-group-item"  style="color: #b66dff; background: #140f0f17;">
		        <a class="nav-link d-flex justify-content-between align-items-center" href="adminMunicipaltyReview.jsp">
		            ...
		            <span><i class="fa-solid fa-building-ngo" style="color: #b66dff;"></i> <i class="fa-solid fa-comments" style="color: #b66dff;"></i></span>
		        </a>
		    </li>
		  ...
		  <li class="nav-item">
			...
			<figure class="text-center" style="margin-bottom: 40px;">
				  <blockquote class="blockquote">
				    <p>View Municipality's feedback</p>
				  </blockquote>
			...
			<div style="height: 370px; width: auto; overflow: auto;">
			    ...
			    <tbody>
			      <%
				 	List<MunicipalityFeedbackDTO> feedback = ServicesDAO.getAllMunicipalityFeedback();
			      for(MunicipalityFeedbackDTO f : feedback){
				  %>
				    <tr>
				    	<td><%=f.getFeedback() %></td>
				    </tr>
