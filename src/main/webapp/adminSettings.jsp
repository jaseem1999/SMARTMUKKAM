...
<div class="container">
	<div class="row">
		<div class="col">
			<form  onsubmit="return validateForm()" action="adminPro" method="post" enctype="multipart/form-data" class="" style="margin-top: 70px; margin-bottom: 50px;">
            ...
            <div class="input-group mb-3">
			    ...
			    <input type="text" class="form-control" id="staff" name="staff" placeholder="Enter position"  required="required">
			</div>
		...
		<div class="col">
			<ul class="list-group list-group-flush">
			  <li class="list-group-item"><img src="adminProView?id=<%=adminId%>" style="height: 100px; width: 100px; border-radius: 50%;" alt="profile"></li>
			  <li class="list-group-item"><%AdminDetailsDTO ad=AdminDAO.getAdminDetails(adminId);
			  	out.print(ad.getName());
			  %></li>
			  <li class="list-group-item"><%=email %></li>
			  <li class="list-group-item"><%=ad.getStaff() %></li>
