...
<%@page import="smartMukkam.com.admin.TouristFeedbackDTO"%>
	   	...
	   	<ul class="list-group list-group-flush">
		    ...
		    <li class="list-group-item" style="color: #b66dff; background: #140f0f17;">
		        <a class="nav-link d-flex justify-content-between align-items-center" href="adminTouristReview.jsp">
		            ...
		            <span><i class="fa-solid fa-mountain-sun" style="color: #b66dff;"></i> <i class="fa-solid fa-comments" style="color: #b66dff;"></i></span>
		        </a>
		    </li>
		    <li class="list-group-item">
		  ...
		  <li class="nav-item">
			...
			<figure class="text-center" style="margin-bottom: 40px;">
				  <blockquote class="blockquote">
				    <p>View Tourist place feedback</p>
				  </blockquote>
			...
			<div style="height: 370px; width: auto; overflow: auto;">
			    ...
			    <tbody>
			      <%
				 	List<TouristFeedbackDTO> tourist = ServicesDAO.getAllTouristFeedback();
			      for(TouristFeedbackDTO t : tourist){
				  %>
				    <tr>
				    	<td><img src="timg?id=<%=t.getToid()%>" style="width: 40px; border: 1px solid; border-radius: 5px;" alt="" ></td>
				    	<td><%=t.getFeedback() %></td>
				    </tr>
