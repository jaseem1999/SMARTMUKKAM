...
%>
    <div class="container">
    	<form  onsubmit="return validateForm()" action="tSign" method="post" enctype="multipart/form-data" class="card" style="margin-top: 70px; margin-bottom: 50px;">
        ...
        <div class="col">
            ...
            <div class="mb-3">
                <label for="touristname" class="form-label">Tourist name</label>
                <input type="text" class="form-control" id="touristname" name="touristname" placeholder="Enter tourist name" required="required">
