...
<%@page import="smartMukkam.com.admin.ShopFeedbackDTO"%>
	   	...
	   	<ul class="list-group list-group-flush">
		    ...
		    <li class="list-group-item" style="color: #b66dff; background: #140f0f17;">
		        <a class="nav-link d-flex justify-content-between align-items-center" href="adminShopReview.jsp">
		            View Feedback Shop
		            <span><i class="fa-solid fa-shop" style="color: #b66dff;"></i> <i class="fa-solid fa-comments"  style="color: #b66dff;"></i></span>
		        </a>
		    </li>
		    <li class="list-group-item">
  ...
  <ul class="nav justify-content-end">
		  ...
		  <li class="nav-item">
			...
			<div style="height: 370px; width: auto; overflow: auto;">
			    ...
			    <tbody>
			      <%
				 	List<ShopFeedbackDTO> shops = ServicesDAO.getAllShopFeedback();
				 	for(ShopFeedbackDTO s : shops){
				  %>
				    <tr>
				    	<td><img src="shopImage?id=<%=s.getSid()%>" style="width: 40px; border: 1px solid; border-radius: 5px;" alt="" ></td>
				    	<td><%=s.getFeedback() %></td>
				    </tr>
